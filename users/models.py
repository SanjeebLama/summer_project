...
class Profile(models.Model):
    ...
    facebook_URL = models.CharField(max_length=25, blank=True)
    instagram_URL = models.CharField(max_length=25, blank=True)
    twitter_URL = models.CharField(max_length=25, blank=True)
    linkedIn_URL = models.CharField(max_length=25, blank=True)
